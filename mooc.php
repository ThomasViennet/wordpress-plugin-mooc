...
function registration()
{
    if (!is_admin()) {
        if (!is_user_logged_in()) {
            ...
            <div class="wp-block-button custom-btn btn-11"><a class="wp-block-button__link has-background-color has-text-color has-background wp-element-button" href="/wp-admin/admin.php?page=dashboard" style="border-radius:100px;background-color:#cd2653">Continuer la formation</a></div>
            </div>';
        }
    }
}
